...
import heroImg from "@/assets/gps/hero.jpg";
import denunciaImg from "@/assets/gps/denuncia.jpg";
import regolamentoImg from "@/assets/gps/copilot2.png";

export const Route = createFileRoute("/gps")({
  head: () => ({
    meta: [
      { title: "Privacy GPS Satellitari — Denuncia Impianto e GDPR | Privacy 1996" },
      {
        name: "description",
        content:
          "Assistenza completa per impianti GPS satellitari: denuncia impianto, regolamento interno, consulenza GDPR e conformità privacy. Faccio tutto io.",
      },
    ],
  }),
  component: GpsPage,
...
const servizi = [
  {
    ...
    desc: "Pensiamo noi alla burocrazia per il tuo impianto di GPS satellitare. Zero pensieri per te.",
  },
  {
    icon: ClipboardList,
  ...
  },
  {
    ...
    desc: "Navighiamo insieme le complessità del GDPR per il tuo GPS satellitare. Conformità garantita.",
  },
];
...
const motivi = [
  {
    icon: BookOpen,
    title: "Esperienza",
    desc: "Conosco le leggi sulla privacy e sui GPS satellitari come le mie tasche. Affidati a chi sa cosa fare.",
  },
  {
    icon: ShieldCheck,
    title: "Tranquillità",
...
const testimonianze = [
  ...
  {
    text: "Servizio completo e professionale. Le informative e i documenti sono chiari e conformi. Ottimo lavoro!",
...
const faq = [
  {
    ...
    a: "Mi occupo di tutta la trafila burocratica per denunciare il tuo impianto GPS satellitare alle autorità competenti, liberandoti da scartoffie e procedure noiose.",
  },
  {
    q: "Quanto tempo ci vuole per essere in regola?",
    a: "Generalmente la procedura richiede pochi giorni lavorativi una volta raccolti tutti i documenti necessari. Ti terrò aggiornato in ogni fase.",
  },
  {
  ...
  {
    q: "E se non mi adeguo?",
    a: "Le sanzioni per la mancata conformità possono essere molto salate. Meglio prevenire che curare, e io sono qui proprio per questo.",
  },
  {
    q: "Quali problemi può causare un impianto GPS senza documentazione privacy?",
    a: "Può portare a sanzioni amministrative e penali, contestazioni legali e obbligo di rimozione. Senza regolamento e denuncia l'impianto risulta irregolare. Mi occupo io di tutto: denuncia, documenti, conformità GDPR.",
  },
  {
    q: "Cosa succede se si ignora la trasparenza nella gestione del GPS satellitare?",
    a: "Si rischia di trasformare uno strumento utile in fonte di problemi e contestazioni. Con il giusto metodo e il rispetto delle norme, tutto resta sotto controllo e protetto.",
  },
];
      ...
      <main className="pt-36 md:pt-44">
        ...
        <section className="pb-16 [background:var(--gradient-section-hero)]">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full border-2 border-primary/30 bg-white px-4 py-2 text-sm font-semibold mb-6">
              <MapPin className="h-4 w-4 text-primary" aria-hidden /> GPS Satellitari &amp; Privacy
            </div>
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
              GPS satellitare a norma, <span className="text-primary">senza stress</span>
            </h1>
            <p className="mt-5 text-lg md:text-xl text-foreground/85 max-w-2xl mx-auto">
              Pratiche obbligatorie, soluzioni semplici. La tua privacy è la mia missione:
              non trasformare uno strumento utile in una fonte di problemi. Ci penso a tutto io.
            </p>
            <p className="mt-3 text-base text-foreground/75 max-w-2xl mx-auto font-semibold">
              Verifica gratuitamente se devi fare qualcosa per il tuo impianto GPS satellitare.
            </p>
            <ChecklistCTAs />
            <div className="mt-6">
            ...
            <div className="mt-12 max-w-3xl mx-auto">
              <img
                src={heroImg}
                alt="Flotta di veicoli con tracciamento GPS satellitare a norma di legge"
          ...
          <div className="container mx-auto px-4 max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-5 space-y-4 text-foreground/85 text-lg leading-relaxed">
                <p>
                  Hai installato dei GPS satellitari e ora ti chiedi come fare per la denuncia?
                  Tranquillo, ci penso io! La denuncia dell'impianto GPS satellitare è un
                  passaggio obbligatorio per essere in regola con la legge. Non lasciare che
                  la burocrazia ti fermi.
                </p>
                <p>
                ...
                <p>
                  Con la mia assistenza, avrai la certezza che il tuo impianto GPS satellitare
                  sia correttamente registrato e conforme alle normative vigenti. Un piccolo
            ...
            <img
              src={denunciaImg}
              alt="Tracciamento GPS satellitare e documentazione per la denuncia impianto"
              className="w-full rounded-2xl border-2 border-primary/15 shadow-lg"
              width={1096}
              height={1096}
              loading="lazy"
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4 max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <img
              src={regolamentoImg}
              alt="Regolamento interno per la gestione del GPS satellitare"
              className="w-full max-w-sm mx-auto rounded-2xl border-2 border-primary/15 shadow-lg order-last md:order-first"
              loading="lazy"
            />
            <div>
              <p className="text-sm font-bold text-primary uppercase tracking-wider mb-2">
              ...
              <div className="mt-5 space-y-4 text-foreground/85 text-lg leading-relaxed">
                <p>
                  Creare un regolamento interno per i sistemi GPS satellitari non è un
                  optional, è un obbligo. Ti aiuto a redigere un documento chiaro e completo
                  che definisca le regole d'uso, le finalità e le modalità di gestione del tuo
                  impianto, mettendo tutti al riparo da sorprese.
                </p>
                <p>
                  Questo documento è fondamentale per dimostrare la tua attenzione alla
                  privacy e per gestire correttamente i dati raccolti dal GPS satellitare.
                ...
                <p>
                  ...
                  fondamenta legali del tuo sistema GPS satellitare, un articolo alla volta.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 max-w-5xl grid sm:grid-cols-3 gap-8 text-center">
            ...
            <div className="sm:col-span-3 mt-6">
              <p className="text-white/95 text-lg font-semibold mb-2">
                Scopri subito se il tuo GPS satellitare è a norma — gratis e senza impegno
              </p>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-12">
              ...
              <p className="mt-3 text-foreground/80">
                Mettiamo in regola il tuo impianto GPS satellitare. Ci penso io a tutto.
              </p>
              <ChecklistCTAs />
            </div>
